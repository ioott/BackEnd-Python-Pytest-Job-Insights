...
TRANSLATED = [
    ...
    {'title': 'Assistente administrativo', 'salary': '1700', 'type': ' full time'},
    ...
    {'title': 'Analista de Departamento Pessoal', 'salary': '4000', 'type': ' full time'},
    {'title': 'Esportista de Futebol profissional', 'salary': '50000', 'type': ' full time'},
